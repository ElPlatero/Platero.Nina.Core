...
namespace Platero.Nina.Core.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private const string URI_DEFAULT_WARN = "https://warnung.bund.de/api31/";
        ...
        public static IServiceCollection AddNinaRepositoryClients(this IServiceCollection services, IOptions<NinaConfiguration> options)
        {
            ...
            return services
                ...
                .AddHttpClient<IWarnMessageRepository, WarnMessageRepository>(c => c.BaseAddress = configuration.Urls?.Warnings ?? new Uri(URI_DEFAULT_WARN)).Services;
        } 
    }
}